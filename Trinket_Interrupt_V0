...
//TIMSK0 &= ~_BV(TOIE0);                                       //Disable Timer0, for gitter free against interrupt.
  ...
  PCMSK0 |= (1 << PCINT1);                                     //Set PCINT3 (digital input 11)to trigger an interrupt on state change.
  PCMSK0 |= (1 << PCINT2);                                     //Set PCINT4 (digital input 8) to trigger an interrupt on state change.
  PCMSK0 |= (1 << PCINT3);                                     //Set PCINT5 (digital input 9)to trigger an interrupt on state change.
  PCMSK0 |= (1 << PCINT4);                                     //Set PCINT6 (digital input 10)to trigger an interrupt on state change.                                   //Set PCINT7 (digital input 11)to trigger an interrupt on state change.
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Main program loop
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
